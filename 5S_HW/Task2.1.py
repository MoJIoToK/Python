...
queue = randint(0,1) # определение очередности
...
# Тоже самое но в функции:
# def Play_Game(player1, player2, amount):
#     queue = randint(0,1) # определение очередности
...
# queue = Play_Game(player1, player2, amount)
